...
function hud_icon_builder:new(game, command, icon_x, icon_y, dialog_icon_x, dialog_icon_y)
  ...
  hud_icon.font_color = {224, 255, 208}
  hud_icon.font_stroke_color = {15, 31, 32}
  hud_icon.font_shadow_color = {143, 192, 112}
  ...
  function hud_icon:on_draw(dst_surface)
    ...
    if hud_icon.enabled or hud_icon.animating then
      ...
      if hud_icon.surface ~= nil then
        ...
        local surface_x, surface_y = center_x - hud_icon.surface_w / 2, center_y - 6 - hud_icon.surface_h / 2
  ...
  function hud_icon:set_foreground_text(text)
    if text == nil or text == "" then
      ...
      if cache_surface == nil then
        ...
        text_fx_helper:draw_text_with_stroke_and_shadow(cache_surface, text_surface, hud_icon.font_stroke_color, hud_icon.font_shadow_color)

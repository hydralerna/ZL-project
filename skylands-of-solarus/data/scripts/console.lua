...
local console = {
  enabled = false,
  color = { 15, 31, 32 },  -- Background color of the console area.
  color2 = { 48, 111, 80 },-- Background color of the title area.
  ...
  title_text_surface = sol.text_surface.create{
    text = "console",
    font = "enter_command",
    color = { 15, 31, 32 },
    font_size = 16,
...
function console:on_started()  --Display the console gui when pressing F12.
  self.enabled = true
  self:build_input_text()
  print("Console enabled...")
end

function console:on_finished() --Close the console gui when pressing F12.
  self.enabled = false
